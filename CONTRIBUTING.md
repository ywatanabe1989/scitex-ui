# Contributing to SciTeX UI

Thank you for your interest in contributing to SciTeX UI. This guide covers the
...
- Search [existing issues](https://github.com/ywatanabe1989/scitex-ui/issues)
  before opening a new one.
- Include a minimal reproducible example when reporting bugs.
- Specify your Python version, OS, and `scitex-ui` version.

## Development Setup

```bash
git clone git@github.com:ywatanabe1989/scitex-ui.git
cd scitex-ui
pip install -e ".[dev]"
```
